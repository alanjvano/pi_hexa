...
def update_scr(stdscr):
    ...
    stdscr.addstr(10,0,'bias_accel       - {0[0]:^6.2f}  {0[1]:^6.2f}  {0[2]:^6.2f}'.format(imu.get().a_bias))
    stdscr.addstr(10,0,'deadband_gyro    - {0[0]:^6.2f}  {0[1]:^6.2f}  {0[2]:^6.2f}'.format(imu.get().g_deadband))
